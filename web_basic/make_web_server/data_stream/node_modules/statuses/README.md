...
- [Statuses](#statuses)
  ...
  - [API](#api)
    - [var code = status(Integer || String)](#var-code--statusinteger--string)
    - [status.STATUS_CODES](#statusstatus_codes)
    - [status.codes](#statuscodes)
    - [var msg = status[code]](#var-msg--statuscode)
    - [var code = status[msg]](#var-code--statusmsg)
    - [status.redirect[code]](#statusredirectcode)
    - [status.empty[code]](#statusemptycode)
    - [status.retry[code]](#statusretrycode)

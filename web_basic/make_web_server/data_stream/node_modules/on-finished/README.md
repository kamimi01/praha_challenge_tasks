...
- [on-finished](#on-finished)
  - [Install](#install)
  - [API](#api)
    - [onFinished(res, listener)](#onfinishedres-listener)
    - [onFinished(req, listener)](#onfinishedreq-listener)
    - [onFinished.isFinished(res)](#onfinishedisfinishedres)
    - [onFinished.isFinished(req)](#onfinishedisfinishedreq)
  - [Special Node.js requests](#special-nodejs-requests)
    - [HTTP CONNECT method](#http-connect-method)

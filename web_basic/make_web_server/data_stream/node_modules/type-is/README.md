...
- [type-is](#type-is)
    - [Install](#install)
  - [API](#api)
    - [typeis(request, types)](#typeisrequest-types)
    - [typeis.hasBody(request)](#typeishasbodyrequest)
    - [typeis.is(mediaType, types)](#typeisismediatype-types)
  - [Examples](#examples)
    - [Example body parser](#example-body-parser)
  - [License](#license)

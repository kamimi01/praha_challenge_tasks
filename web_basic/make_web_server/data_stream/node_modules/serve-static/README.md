...
- [serve-static](#serve-static)
  - [Install](#install)
  - [API](#api)
    - [serveStatic(root, options)](#servestaticroot-options)
      - [Options](#options)
  ...
  - [Examples](#examples)
    - [Serve files with vanilla node.js http server](#serve-files-with-vanilla-nodejs-http-server)
    - [Serve all files as downloads](#serve-all-files-as-downloads)
    - [Serving using express](#serving-using-express)
      - [Simple](#simple)
      - [Multiple roots](#multiple-roots)
      - [Different settings for paths](#different-settings-for-paths)
  - [License](#license)

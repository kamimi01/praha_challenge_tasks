...
- [send](#send)
  ...
  - [API](#api)
    - [send(req, path, [options])](#sendreq-path-options)
      - [Options](#options)
  ...
  - [Examples](#examples)
    - [Serve a specific file](#serve-a-specific-file)
    - [Serve all files from a directory](#serve-all-files-from-a-directory)
    - [Custom file types](#custom-file-types)
    - [Custom directory index view](#custom-directory-index-view)
    - [Serving from a root directory with custom error-handling](#serving-from-a-root-directory-with-custom-error-handling)
  - [License](#license)
